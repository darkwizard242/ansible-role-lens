...
lens_debian_url: "https://api.k8slens.dev/binaries/Lens-{{ lens_version }}-latest.20220120.1.amd64.deb"

# For EL Family
lens_el_url: "https://api.k8slens.dev/binaries/Lens-{{ lens_version }}-latest.20220120.1.x86_64.rpm"
```
...
lens_version       | Defined to dynamically fetch the desired version to install. Defaults to: **5.3.4**
