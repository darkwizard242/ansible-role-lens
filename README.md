...
lens_debian_url: "https://api.k8slens.dev/binaries/Lens-{{ lens_version }}-latest.20220728.2.amd64.deb"

# For EL Family
lens_el_url: "https://api.k8slens.dev/binaries/Lens-{{ lens_version }}-latest.20220728.2.x86_64.rpm"
```
...
lens_version       | Defined to dynamically fetch the desired version to install. Defaults to: **6.0.0**
